//
//  Maj1Min2ViewController.m
//  e rcv
//
//  Created by Charles Yang on 8/11/13.
...
@interface Maj1Min2ViewController ()

@end

@implementation Maj1Min2ViewController
...
- (void)viewDidLoad
{
    ...
    [self addMotionEffectToView:_visualImageView magnitude:-5.0f];
    [self addMotionEffectToView:_contentBodyView magnitude:5.0f];
